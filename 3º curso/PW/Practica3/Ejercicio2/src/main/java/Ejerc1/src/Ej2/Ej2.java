				...
				switch(bucle2) {
					...
					case 3: {
						try {
							...
							EspectaculoDTO nuevoEspectaculo = new EspectaculoDTO(newTitle, newDescriptition, newCategory, newAfo, 1);
					...
					case 9:{
						try {
							System.out.println("Introduce la id de la critica que deseas eliminar: ");
							String id_str = reader.readLine();
							int id = Integer.parseInt(id_str);
							gestorCritica.EliminarCritica(id);
