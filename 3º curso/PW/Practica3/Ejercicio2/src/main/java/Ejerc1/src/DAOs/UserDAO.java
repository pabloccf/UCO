...
public class UserDAO {
        ...
        try{
            ...
            Class.forName("com.mysql.jdbc.Driver");            
              ...
              PreparedStatement ps = connection.prepareStatement("INSERT INTO Usuarios values(?,?,?,?,?,?,?)");
                ...
                ps.setString(6,user.getTipoAsString());
                ps.setString(7,user.getFecha());
    ...
    public UserDTO buscarUsuarioPorUsername(String nick) {
        ...
        try{
            ...
            String sqlString = "select u.Nombre, u.Apellidos, u.Username, u.Password, u.Email, u.Tipo, u.Fecha from `Usuarios` u where u.username = '" + nick + "'";
            ...
            while (rs.next()) {
                ...
                user.setFecha(rs.getString("u.Fecha"));
            }
    ...
    public UserDTO buscarUsuarioPorCorreo(String mail) {
        ...
        try{
            ...
            String sqlString = "select u.Nombre, u.Apellidos, u.Username, u.Password, u.Email, u.Tipo, u.Fecha from `Usuarios` u where u.Email = '" + mail + "'";
            ResultSet rs = statement.executeQuery(sqlString);
