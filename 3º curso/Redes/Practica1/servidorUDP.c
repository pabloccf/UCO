    ...
    while (1){
        ...
        if (recibido == 'DAY' || recibido == 'TIME' || recibido == 'DAYTIME'){
            ...
            /*FORMATOS PARA USAR CON LA ESTRUCTURA stTm
                ...
                %d - dia del mes en dos digitos (01-31)
                %m - el mes en dos digitos (01-12)
                %D  - fecha en formato %m/%d/%y
                %H - hora en dos digitos (00-23)
                %M - minutos en dos digitos
                %S- segundos en dos digitos
                %Y - nos devuelve el año en cuatro digitos*/
