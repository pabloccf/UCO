...
using namespace std;
 ...
 private: 
     ...
     StringSingleton(){} // default constructor available only to members
                         // Invocado en el new del constructor static public:
...
int f()
{
StringSingleton &r=StringSingleton::Instance();
