...
int main(){
    ...
    case 0:
        ...
        /*
            fildes[0] es lectura ya que el 0 se refiere a lectura
            fildes[1] es escritura ya que el 1 se refiere a escritura
        */
        ...
        if (nbytes == -1){ //Comprueba que no haya error al leer en la tuberia
            ...
            char *token;  //Variables donde voy a guardar los numeros
            char *token_2;  //Variables donde voy a guardar los numeros
            token = strtok(buf, ";");    //Leo el primer número. Pone un ; porque en el buffer los numeros estan separados a traves de un ;
            token_2 = strtok(NULL, ";"); //Leo el segundo número. Pone un ; porque en el buffer los numeros estan separados a traves de un ;
    ...
    default:
        ...
        if (close(fildes_2[0]) == -1){ //Se termina de leer -> Cerramos fildes_2[0]
            perror("Error en close");
            exit(EXIT_FAILURE);
        }
